...
ROLE_PERMS = {
    ...
    Role.ANALYST: frozenset({ValidationPermission.VAL_READ, ValidationPermission.VAL_RUN}),
    Role.OPERATOR: frozenset({ValidationPermission.VAL_READ, ValidationPermission.VAL_RUN}),
