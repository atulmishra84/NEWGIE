...
from validation_intelligence.adapters.rest.errors import register_exception_handlers
from validation_intelligence.adapters.rest.middleware import ObservabilityMiddleware
from validation_intelligence.adapters.rest.routes_validation import alias, router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="GIE Validation Intelligence Agent",
        version=AGENT_VERSION,
        description="Validate every generated policy before deployment (gie.validation.v1)",
        lifespan=lifespan,
    )
