...
TOOLS = [
    {
        "name": "analyze",
        "description": "Run unified GIE analysis pipeline",
        "inputSchema": {
            "type": "object",
    ...
    {
        "name": "get_status",
        "description": "Orchestrator and agent health",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "execution_graph",
        "description": "Mermaid execution graph",
        "inputSchema": {
            "type": "object",
...
async def call_tool(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    if name == "get_status":
        ...
        return {
            ...
            "active": await c.executions.count_active(),
        }
    if name == "execution_graph":
        wf = default_analyze_workflow(
            parallel_enabled=bool(arguments.get("parallel", True))
        )
