...
from recommendation_intelligence.domain.llm_enhancer import enhance_recommendation_report
...
class GenerateRecommendationsHandler:
    ...
    async def handle(self, request: RecommendationGenerateRequest, *, actor: str, correlation_id: str) -> RecommendationReport:
        ...
        if self._llm:
            ...
            _enhanced = await enhance_recommendation_report(report_dict, client=self._llm)
