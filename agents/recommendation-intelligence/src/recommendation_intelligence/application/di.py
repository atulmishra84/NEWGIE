...
from recommendation_intelligence.application.approve import (
    ApproveRecommendationsHandler,
)
from recommendation_intelligence.application.generate import (
...
class Container:
    ...
    def approve(self) -> ApproveRecommendationsHandler:
        return ApproveRecommendationsHandler(
            reports=self.reports,
            cache=self.cache,
            events=self.events,
            settings=self.settings,
