...
from recommendation_intelligence.infrastructure.memory_store import (
    InMemoryCache,
    InMemoryRecommendationReportRepository,
...
async def build_container(
    *, memory: bool = True, settings: Settings | None = None
    ...
    c = Container(
        settings=settings,
        reports=InMemoryRecommendationReportRepository(),
        cache=InMemoryCache(),
