...
from explainability_intelligence.domain.ports import (
    CacheStore,
    EventPublisher,
...
class ExplainHandler:
    ...
    async def handle(
        self, request: ExplainRequest, *, actor: str, correlation_id: str
    ) -> ExplanationReport:
        ...
        logger.info(
            ...
            explanation_id=str(report.explanation_id),
            actor=actor,
        )
        return report
