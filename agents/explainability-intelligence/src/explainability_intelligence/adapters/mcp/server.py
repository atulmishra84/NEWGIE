...
TOOLS = [
    {
        ...
        "description": "Explain a GIE agent decision",
        "inputSchema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": "Fetch explanation by id",
        "inputSchema": {
            "type": "object",
    ...
    {
        "name": "reasoning_path",
        "description": "Build reasoning path + mermaid/figma payload",
        "inputSchema": {
            "type": "object",
            "properties": {"tenant_id": {"type": "string"}, "steps": {"type": "array"}},
            "required": ["tenant_id"],
        },
    },
    {
        "name": "figma_generate_diagram",
        "description": "Get FigJam generate_diagram payload",
        "inputSchema": {
            "type": "object",
            "properties": {"explanation_id": {"type": "string"}},
        },
    },
]
...
async def call_tool(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    if name == "explain_decision":
        ...
        report = await c.explain.handle(
            ExplainRequest(bundle=bundle), actor="mcp", correlation_id=uuid4().hex
        )
