        ...
        recommendations=[
            {
                ...
                "supporting_evidence": ["Signal matched: prompt_injection", "Overall AI risk score=0.72"],
                "related_guardrails": ["gr-prompt-firewall"],
                "knowledge_refs": ["owasp-llm01", "atlas-prompt-injection"],
            }
        ],
        risk={"overall_ai_risk_score": 0.72, "factors": [{"category": "prompt_injection", "score": 0.8, "severity": "critical"}]},
        compliance={"compliance_score": 0.4, "applicable_frameworks": [{"framework": "eu_ai_act"}], "gaps": [{"control_id": "euai-transparency", "severity": "high"}]},
