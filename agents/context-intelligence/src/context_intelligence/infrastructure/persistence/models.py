...
class Scan(Base):
    ...
    __table_args__ = (
        UniqueConstraint("tenant_id", "idempotency_key", name="uq_scans_tenant_idempotency"),
...
class ModelVersion(Base):
    ...
    model_id: Mapped[UUID] = mapped_column(
        PGUUID(as_uuid=True), ForeignKey("context_models.id"), nullable=False, index=True
    )
...
class Finding(Base):
    ...
    model_id: Mapped[UUID | None] = mapped_column(PGUUID(as_uuid=True), nullable=True, index=True)
