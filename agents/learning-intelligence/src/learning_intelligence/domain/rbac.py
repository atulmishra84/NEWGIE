...
ROLE_PERMS = {
    ...
    Role.ANALYST: frozenset({LearningPermission.LEARN_READ, LearningPermission.LEARN_FEEDBACK, LearningPermission.LEARN_RUN}),
    Role.OPERATOR: frozenset({LearningPermission.LEARN_READ, LearningPermission.LEARN_FEEDBACK, LearningPermission.LEARN_RUN, LearningPermission.LEARN_APPROVE}),
