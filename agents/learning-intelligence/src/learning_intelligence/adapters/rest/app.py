...
from learning_intelligence.adapters.rest.errors import register_exception_handlers
from learning_intelligence.adapters.rest.middleware import ObservabilityMiddleware
from learning_intelligence.adapters.rest.routes_learning import alias, router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="GIE Learning Intelligence Agent",
        version=AGENT_VERSION,
        description="Continuously improve policy recommendations (gie.learning.v1)",
        lifespan=lifespan,
    )
