...
def sample_bundle():
    return LearningInputBundle(
        ...
        threat_intelligence=[
            {
                "title": "ATLAS new technique T1543",
                "severity": "high",
                "signals": {"technique_id": "T1543", "atlas_id": "AML.T0051"},
            }
        ],
        regulatory_updates=[
            {
                "title": "EU AI Act transparency amendment",
                "severity": "high",
                "signals": {"framework": "eu_ai_act"},
            }
        ],
        policy_changes=[{"title": "opa.rego updated in prod", "severity": "medium"}],
        model_changes=[{"title": "Switched to gpt-4.1", "severity": "medium"}],
        runtime_telemetry=[
            {"title": "edge block metrics", "signals": {"block_rate": 0.32}}
        ],
        user_feedback=[
            {"title": "Too noisy", "signals": {"sentiment": "negative", "rating": "2"}}
        ],
