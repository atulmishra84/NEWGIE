...
ROLE_PERMS: dict[Role, frozenset[PolicyPermission]] = {
    Role.VIEWER: frozenset({PolicyPermission.POLICY_READ, PolicyPermission.POLICY_EXPLAIN}),
    Role.ANALYST: frozenset({PolicyPermission.POLICY_READ, PolicyPermission.POLICY_EXPLAIN, PolicyPermission.POLICY_GENERATE}),
    Role.OPERATOR: frozenset({PolicyPermission.POLICY_READ, PolicyPermission.POLICY_EXPLAIN, PolicyPermission.POLICY_GENERATE}),
