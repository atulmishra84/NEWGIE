...
def render(recs: list[GuardrailRecommendation], bundle: PolicyInputBundle) -> dict[str, Any]:
    return {
        ...
        "crewai": {
            "process": "hierarchical" if any(r.guardrail_id=="gr-identity-rbac" for r in recs) else "sequential",
            ...
            "task_guards": {"output_pydantic_validation": True, "max_execution_time": 120},
        },
