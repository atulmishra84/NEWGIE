...
CATALOG: list[GuardrailSpec] = [
    GuardrailSpec("gr-prompt-injection", "Prompt Injection Defense", "input_security",
        ("prompt injection", "llm01", "jailbreak", "langgraph", "crewai", "autogen", "openai", "agents"),
        Priority.P0, BusinessImpact.CRITICAL, Effort.MEDIUM,
    ...
    GuardrailSpec("gr-output-filter", "Output Content Filtering", "output_security",
        ("sensitive", "pii", "secret", "llm06", "disclosure", "healthcare", "hipaa", "pci"),
        Priority.P0, BusinessImpact.CRITICAL, Effort.MEDIUM,
    ...
    GuardrailSpec("gr-tool-allowlist", "Tool / Function Allowlist", "agency_control",
        ("tool", "mcp", "plugin", "function calling", "llm07", "llm08", "excessive agency", "autonomous"),
        Priority.P0, BusinessImpact.HIGH, Effort.MEDIUM,
    ...
    GuardrailSpec("gr-pii-presidio", "PII Detection & Anonymization", "privacy",
        ("pii", "presidio", "gdpr", "hipaa", "personal data", "phi", "healthcare"),
        Priority.P1, BusinessImpact.HIGH, Effort.LOW,
    ...
    GuardrailSpec("gr-rate-limit", "Rate & Cost Controls", "availability",
        ("dos", "llm04", "cost", "token", "rate"),
        Priority.P1, BusinessImpact.MEDIUM, Effort.LOW,
        ("rate_limit", "token_budget"),
        ("owasp-llm04", "gr-rate-limit", "rt-max-tokens"),
        "Availability/cost risk signals require throttling ({signals})."),
    GuardrailSpec("gr-identity-rbac", "Agent Identity & RBAC", "identity",
        ("identity", "rbac", "oauth", "entra", "auth0", "workload identity", "api key"),
        Priority.P1, BusinessImpact.HIGH, Effort.MEDIUM,
    ...
    GuardrailSpec("gr-topic-safety", "Topic & Safety Blocklist", "safety",
        ("moderation", "safety", "content filter", "nemo", "foundry", "openai"),
        Priority.P2, BusinessImpact.MEDIUM, Effort.LOW,
    ...
    GuardrailSpec("gr-opa-runtime", "OPA Runtime Admission Policies", "runtime_policy",
        ("kubernetes", "opa", "rego", "deployment", "runtime", "egress"),
        Priority.P1, BusinessImpact.HIGH, Effort.HIGH,
    ...
    GuardrailSpec("gr-nemo-rails", "NVIDIA NeMo Guardrails", "vendor_rail",
        ("nemo", "nvidia", "colang", "rails"),
        Priority.P2, BusinessImpact.MEDIUM, Effort.MEDIUM,
    ...
    GuardrailSpec("gr-eu-ai-transparency", "EU AI Act Transparency", "compliance",
