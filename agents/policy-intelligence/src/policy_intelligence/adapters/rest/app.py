...
from policy_intelligence.adapters.rest.errors import register_exception_handlers
from policy_intelligence.adapters.rest.middleware import ObservabilityMiddleware
from policy_intelligence.adapters.rest.routes_policy import router as policy_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="GIE Policy Intelligence Agent",
        version=AGENT_VERSION,
        description="Determines applicable guardrails and emits deployment-ready policies (gie.policy.v1)",
        lifespan=lifespan,
    )
