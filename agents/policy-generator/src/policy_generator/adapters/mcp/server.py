...
TOOLS = [
    {
        ...
        "description": "Generate deployment-ready policies from recommendations",
        "inputSchema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": "Validate a policy package or content",
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "policy_get",
        "description": "Get policy package by id",
        "inputSchema": {
            "type": "object",
