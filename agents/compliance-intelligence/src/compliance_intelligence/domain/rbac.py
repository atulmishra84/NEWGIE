...
ROLE_PERMS = {
    ...
    Role.ANALYST: frozenset(
        {
            CompliancePermission.COMPLIANCE_READ,
            CompliancePermission.COMPLIANCE_ANALYZE,
            CompliancePermission.COMPLIANCE_VALIDATE,
        }
    ),
...
def require_compliance_permission(roles, permission: CompliancePermission) -> None:
    ...
    if (
        ...
        and CompliancePermission.COMPLIANCE_ADMIN not in granted
    ):
