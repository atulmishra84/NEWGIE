...
TOOLS = [
    {
        "name": "compliance_analyze",
        "description": "Analyze applicable regulations and gaps",
        "inputSchema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": "Validate controls with evidence",
        "inputSchema": {
            "type": "object",
            "properties": {
                "tenant_id": {"type": "string"},
                "application_id": {"type": "string"},
                "implemented_controls": {"type": "array"},
                "evidence": {"type": "array"},
            },
            "required": ["tenant_id", "application_id"],
        },
    },
    {
        "name": "compliance_report",
        "description": "Get compliance dashboard/report",
        "inputSchema": {
            "type": "object",
            "properties": {
                "tenant_id": {"type": "string"},
...
async def call_tool(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    if name == "compliance_analyze":
        ...
        report = await c.analyze.handle(
            ComplianceAnalyzeRequest(bundle=bundle),
            actor="mcp",
