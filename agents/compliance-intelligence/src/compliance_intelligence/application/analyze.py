...
from compliance_intelligence.domain.llm_enhancer import enhance_compliance_report
...
class AnalyzeComplianceHandler:
    ...
    async def handle(
        self, request: ComplianceAnalyzeRequest, *, actor: str, correlation_id: str
    ) -> ComplianceReport:
        ...
        if self._llm:
            ...
            _enhanced = await enhance_compliance_report(report_dict, client=self._llm)
