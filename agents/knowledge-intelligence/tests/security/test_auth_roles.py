from knowledge_intelligence.domain.rbac import KnowledgePermission, has_knowledge_permission
...
def test_analyst_readonly():
    ...
    assert not has_knowledge_permission({"analyst"}, KnowledgePermission.KNOWLEDGE_REINDEX)
