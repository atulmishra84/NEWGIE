...
class IntegrationClient:
    def __init__(self, base_url: str = "http://localhost:8090", token: str | None = None, api_key: str | None = None):
    ...
    def sync(self, connection_id: str, payload: dict[str, Any] | None = None, tenant_id: str = "default") -> dict[str, Any]:
        r = self._client.post(
