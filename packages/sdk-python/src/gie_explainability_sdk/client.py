...
class ExplainabilityClient:
    def __init__(self, base_url: str = "http://localhost:8087", token: str | None = None, api_key: str | None = None):
    ...
    def explain(self, bundle: dict[str, Any], *, persist: bool = True) -> dict[str, Any]:
        r = self._client.post("/v1/explain", json={"bundle": bundle, "persist": persist})
        r.raise_for_status()
        return r.json()
    ...
    def figma_generate_diagram(self, explanation_id: str | None = None) -> dict[str, Any]:
