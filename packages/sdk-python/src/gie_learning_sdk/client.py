...
class LearningClient:
    def __init__(self, base_url: str = "http://localhost:8089", token: str | None = None, api_key: str | None = None):
    ...
    def feedback(self, event: dict[str, Any], *, persist: bool = True) -> dict[str, Any]:
