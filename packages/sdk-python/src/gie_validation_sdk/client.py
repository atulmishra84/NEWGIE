...
class ValidationClient:
    def __init__(self, base_url: str = "http://localhost:8088", token: str | None = None, api_key: str | None = None):
    ...
    def validate(self, bundle: dict[str, Any], *, persist: bool = True, run_simulation: bool = True) -> dict[str, Any]:
        r = self._client.post("/v1/validate", json={"bundle": bundle, "persist": persist, "run_simulation": run_simulation})
        r.raise_for_status()
        return r.json()
