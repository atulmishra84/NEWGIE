...
class PolicyGeneratorClient:
    def __init__(self, base_url: str = "http://localhost:8086", token: str | None = None, api_key: str | None = None):
    ...
    def generate(self, bundle: dict[str, Any], *, persist: bool = True) -> dict[str, Any]:
        r = self._client.post("/v1/policy/generate", json={"bundle": bundle, "persist": persist})
        r.raise_for_status()
        return r.json()
